...
The key concept is that we need to understand what is required in /their/ class and ensure that we add /our/ file so that it will match /their/ require earlier in the =$LOAD_PATH=.
